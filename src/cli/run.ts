...
const COMMANDS: Record<string, Command> = {
  ...
  apply: { handler: elements.apply, summary: 'Apply a {create,update,delete} patch in one call', usage: 'apply [patch.json] (or stdin)' },
...
function printHelp(): void {
  const lines = [
    ...
    '  Commands auto-start the canvas server (disable with EXCALIDRAW_NO_AUTOSTART=1).',
